...
using AutoMapper;
using ContosoO365DocSync.Common;
...
namespace ContosoO365DocSync.Service
{
    public class DestinationService : IDestinationService
    {
        ...
        public DestinationService(ContosoO365DocSyncDbContext dbContext, IMapper mapper, IAzureStorageService azureStorageService, ILogService logService, IUserProfileService userProfileService)
        {
